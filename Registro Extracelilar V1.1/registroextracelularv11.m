function varargout = registroextracelularv11(varargin)
%
% Begin initialization code - DO NOT EDIT
gui_Singleton = 1;
gui_State = struct('gui_Name',       mfilename, ...
                   'gui_Singleton',  gui_Singleton, ...
                   'gui_OpeningFcn', @registroextracelularv11_OpeningFcn, ...
                   'gui_OutputFcn',  @registroextracelularv11_OutputFcn, ...
                   'gui_LayoutFcn',  [] , ...
                   'gui_Callback',   []);
...
% --- Executes just before registroextracelularv11 is made visible.
function registroextracelularv11_OpeningFcn(hObject, eventdata, handles, varargin)
% This function has no output args, see OutputFcn.
% hObject    handle to figure
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
% varargin   command line arguments to registroextracelularv11 (see VARARGIN)

% Choose default command line output for registroextracelularv11
handles.output = hObject;

% Update handles structure
guidata(hObject, handles);

% UIWAIT makes registroextracelularv11 wait for user response (see UIRESUME)
% uiwait(handles.figure1);


% --- Outputs from this function are returned to the command line.
function varargout = registroextracelularv11_OutputFcn(hObject, eventdata, handles) 
