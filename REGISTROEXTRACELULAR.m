function varargout = REGISTROEXTRACELULAR(varargin)
%
% Begin initialization code - DO NOT EDIT
gui_Singleton = 1;
gui_State = struct('gui_Name',       mfilename, ...
                   'gui_Singleton',  gui_Singleton, ...
                   'gui_OpeningFcn', @REGISTROEXTRACELULAR_OpeningFcn, ...
                   'gui_OutputFcn',  @REGISTROEXTRACELULAR_OutputFcn, ...
                   'gui_LayoutFcn',  [] , ...
                   'gui_Callback',   []);
...
% --- Executes just before REGISTROEXTRACELULAR is made visible.
function REGISTROEXTRACELULAR_OpeningFcn(hObject, eventdata, handles, varargin)
% This function has no output args, see OutputFcn.
% hObject    handle to figure
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
% varargin   command line arguments to REGISTROEXTRACELULAR (see VARARGIN)

% Choose default command line output for REGISTROEXTRACELULAR
handles.output = hObject;

% Update handles structure
guidata(hObject, handles);

% UIWAIT makes REGISTROEXTRACELULAR wait for user response (see UIRESUME)
% uiwait(handles.figure1);


% --- Outputs from this function are returned to the command line.
function varargout = REGISTROEXTRACELULAR_OutputFcn(hObject, eventdata, handles) 
